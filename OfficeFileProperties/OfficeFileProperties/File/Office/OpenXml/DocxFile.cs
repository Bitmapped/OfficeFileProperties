...
{
    /// <summary>
    /// Obtain properties of Microsoft Word DOCX files.
    /// </summary>
    class DocxFile : IFile
    {
        // Define private variables.
        private string filename;
        private WordprocessingDocument file;
        ...
        public DocxFile(string filename) : this()
        {
            // Load specified file.
        ...
        public void LoadFile(string filename)
        {
            ...
            // Load file.
            this.file = WordprocessingDocument.Open(filename, false);
